...
async fn save_voting() {
    ...
    let votings = vec![
        Voting {
            id: "84ee17be18185a077db2".to_owned(),
            name: "voting1".to_owned(),
            choices: vec!["choice1".to_owned(), "choice2".to_owned()],
            is_completed: false,
            is_deleted: false,
            message_id: "message_id".to_owned(),
            channel_id: "channel_id".to_owned(),
            creator_message_id: "creator_message_id".to_owned(),
            creator_dm_channel_id: "creator_dm_channel_id".to_owned(),
        },
        Voting {
            id: "84ee17be18185a077db3".to_owned(),
            name: "voting2".to_owned(),
            choices: vec!["choice1".to_owned(), "choice2".to_owned()],
            is_completed: false,
            is_deleted: false,
            message_id: "message_id".to_owned(),
        ...
        Voting {
            id: "84ee17be18185a077db4".to_owned(),
            name: "voting2".to_owned(),
            choices: vec!["choice1".to_owned(), "choice2".to_owned()],
            is_completed: false,
            is_deleted: false,
...
async fn test_custom_id() {
    ...
    // voting 2
    let voting_id2 = "84ee17be18185a077db3".to_owned();
...
async fn test_delete_custom_ids() {
    ...
    for _ in 0..10 {
        ...
        let custom_id = CustomID {
            action: Action::VoteFromChannel,
            voting_id: voting_id1.to_owned(),
            user_id: Some(user_id1.to_owned()),
            page: None,
            index: None,
        };
    ...
    for _ in 0..5 {
        ...
        let custom_id = CustomID {
            action: Action::VoteFromChannel,
            voting_id: voting_id2.to_owned(),
            user_id: Some(user_id2.to_owned()),
            page: None,
            index: None,
        };
...
fn generate_random_hex_string(length: usize) -> String {
    ...
    let bytes: Vec<u8> = std::iter::repeat_with(|| rng.gen()).take(length / 2).collect();
    encode(bytes)
}
